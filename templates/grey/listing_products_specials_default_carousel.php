...
if (PRODUCT_LIST_ONMOUSEOVER_BUTTONS == "true") {
	...
	$add_button_buynow = '<br>'.$button_buynow;
	  ...
	  $info_box_contents = '<li><span class="smallText"><div class="pl_style_border_div" onmouseover="document.getElementById(\'div_name'.$random_product['products_id'].'\').style.display=\'\';" 
