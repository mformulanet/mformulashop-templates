...
if (defined('CAROUSEL_DEFAULT') && CAROUSEL_DEFAULT == 'true') {
	...
	$info_box_contents = '
										   <li><span class="smallText"><div class="pl_style_border_div">
...
if (PRODUCT_LIST_ONMOUSEOVER_BUTTONS == "true") {
	...
	$info_box_contents = '<li><span class="smallText"><div class="pl_style_border_div">'.$add_categories_subcategories.'<span class="pl_expire_date">'.$specials_expiredate.'</span>'.$products_image_list.$add_likes_box.''.$button_free_shipping.'<br><br>'.$button_youtube.'<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_id) . '" itemprop="url">'.$manufacturers_name.$products_model.'<span class="pl_product_name">' . $products_name . '</span></a>'.$unidade_venda.'<br>'.$price_product.$add_button_buynow.'</div></span></li>';
