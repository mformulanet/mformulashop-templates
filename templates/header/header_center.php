...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="background_header">
  ...
  <tr>
	...
	// logo eof
	?></td>
    <td width="40%" align="right" <?php if ($background_header_right != ""){ echo ' style="background-image:url('.$background_header_right.'); background-position:right; background-repeat:no-repeat;"'; } ?>><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
...
?>
              <table height="40" border="0" cellspacing="0" cellpadding="0" class="background_content_header_box_shopping_cart">
                <tr>
                  <td><script type="text/javascript" src="scripts/dropdowncontent.js"></script>
