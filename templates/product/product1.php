...
?>
                  ...
                  <tr>
					...
					$check_seller_query = tep_db_query( "select c.followers, c.seller_name, a.entry_zone_id, a.entry_country_id from " . TABLE_CUSTOMERS . " c left join " . TABLE_ADDRESS_BOOK . " a on c.customers_default_address_id = a.address_book_id where a.customers_id = c.customers_id and c.customers_id = '" . (int)$product_info['seller_member_id'] . "'" );
