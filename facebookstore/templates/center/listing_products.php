...
// likes eof
	    ...
	    <tr>
		  ...
		  echo $button_youtube;
		  echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product['products_id']) . '">'.$products_model.'<span class="pl_product_name">'.$random_product['products_name'] . '</span></a>'.$unidade_venda.$whats_new_price.'</td>';
		  echo '
...
onmouseout="document.getElementById(\'div_name'.$random_product['products_id'].'\').style.display=\'none\';">'.$add_categories_subcategories.$products_image_list.$add_likes_box.''.$button_free_shipping.'<br>'.$button_youtube.'<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product['products_id']) . '">'.(!empty($manufacturers_name) ? $manufacturers_name.'<br>' : '').$products_model.'<span class="pl_product_name">'.$random_product['products_name'] . '</span></a>'.$unidade_venda.'<br>'.$whats_new_price . '<span class="pl_expire_date">' . $specials_expiredate . '</span>'.$add_button_buynow.'</div></td>' . "\n";
