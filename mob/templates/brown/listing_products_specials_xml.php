...
// price and parcel
		...
		if ( ($CUSTOMER_CREATE_ACCOUNT_VIEW_PRICE == 'true') || ($view_price == 1) || ($registry_mode_id != 0) || ( (CUSTOMER_VIEW_PRODUCT_LOGIN_OR_CREATE_ACCOUNT_VIEW_PRICE == 'true') && (!tep_session_is_registered('customer_id')) ) || ( ($products_quantity < 1) &&  ($products_qtd_stock_status == '0') ) || ( ($products_quantity < 1) &&  ($products_qtd_stock_status == '2') ) || ( ($products_quantity < 1) &&  ($products_qtd_stock_status == '3') ) ) {

		
			$price_product = '';
		
		}elseif ( ($products_quantity > 0) || ( ($products_quantity <= 0) && ($products_qtd_stock_status == '1') ) ) {
...
// price and parcel
		...
		if ( ($CUSTOMER_CREATE_ACCOUNT_VIEW_PRICE == 'true') || ($view_price == 1) || ($registry_mode_id != 0) || ( (CUSTOMER_VIEW_PRODUCT_LOGIN_OR_CREATE_ACCOUNT_VIEW_PRICE == 'true') && (!tep_session_is_registered('customer_id')) ) || ( ($products_quantity < 1) &&  ($products_qtd_stock_status == '0') ) || ( ($products_quantity < 1) &&  ($products_qtd_stock_status == '') ) || ( ($products_quantity < 1) &&  ($products_qtd_stock_status == '2') ) || ( ($products_quantity < 1) &&  ($products_qtd_stock_status == '3') ) ) {
...
onmouseout="document.getElementById(\'div_name'.$products_id.'\').style.display=\'none\';">'.$add_categories_subcategories.'<span class="pl_expire_date">'.$specials_expiredate.'</span>'.$products_image_list.''.$button_free_shipping.'<br><br>'.$button_youtube.'<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_id) . '" itemprop="url">'.$manufacturers_name.$products_model.'<span class="pl_product_name">' . $products_name . '</span></a>'.$unidade_venda.'<br>'.$price_product.'<br>'.$button_buynow.'</div>');
