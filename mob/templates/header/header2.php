...
-->
				...
				<table border="0" cellpadding="0" cellspacing="5">
				  <tr>
					...
					echo '<a href="'.tep_href_link(FILENAME_SHOPPING_CART).'" id="searchlink" rel="shopping_cart"><span class="line_header_box_shopping_cart">'.'(' . $cart->count_contents() . ')' .'</span></a>'; 
					}else{
					echo '<a href="'.tep_href_link(FILENAME_SHOPPING_CART).'" id="searchlink" rel="shopping_cart"><span class="line_header_box_shopping_cart">'.'</span></a>'; 
					}
					?>
					<?php
					if (substr(basename($PHP_SELF), 0, 8) != 'checkout') {
