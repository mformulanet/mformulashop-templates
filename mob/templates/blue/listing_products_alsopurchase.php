...
// button youtube play eof
	  ...
	  $info_box_contents[$row][$col] = array('align' => 'center',
                                          ...
                                          'text' => '<div class="pl_style_border_div">
										   ...
										   <br>'.$button_youtube.'<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product['products_id']) . '">' . $manufacturers_name . $products_model1 . '<span class="pl_product_name">' . $random_product['products_name'] . '</span></a>'.$unidade_venda.$whats_new_price.'
...
if ( ($CUSTOMER_CREATE_ACCOUNT_VIEW_PRICE == 'true') || ($random_product['view_price'] == 1) || ($registry_mode_id != 0) || ( (CUSTOMER_VIEW_PRODUCT_LOGIN_OR_CREATE_ACCOUNT_VIEW_PRICE == 'true') && (!tep_session_is_registered('customer_id')) ) || ( ($random_product['products_quantity'] < 1) &&  ($random_product['products_qtd_stock_status'] == '0') ) || ( ($random_product['products_quantity'] < 1) &&  ($random_product['products_qtd_stock_status'] == '2') ) || ( ($random_product['products_quantity'] < 1) &&  ($random_product['products_qtd_stock_status'] == '3') ) ) {
...
onmouseout="document.getElementById(\'div_name'.$random_product['products_id'].'\').style.display=\'none\';">'.$add_categories_subcategories.$products_image_list.''.$button_free_shipping.'<br><br>'.$button_youtube.'<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product['products_id']) . '">' . $manufacturers_name . $products_model1 . '<span class="pl_product_name">' . $random_product['products_name'] . '</span></a>'.$unidade_venda.'<br>'.$whats_new_price.'<span class="pl_expire_date">'.$specials_expiredate.'</span><br>'.$button_buynow.'</div>');
