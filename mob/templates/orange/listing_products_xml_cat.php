...
onmouseout="document.getElementById(\'div_name'.$products_id.'\').style.display=\'none\';">'.$products_image_list.''.$button_free_shipping.'<br><br>'.$button_youtube.'<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_id) . '" itemprop="url">' . $manufacturers_name . $products_model.'<span class="pl_product_name">' . $products_name . '</span></a>'.$unidade_venda.'<br>'.$whats_new_price.$button_new.$button_update.'<span class="pl_expire_date">'.$specials_expiredate.'</span><br>'.$button_buynow.'</div>');
